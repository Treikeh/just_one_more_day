...
//     version 1.14.0
//     from Assets/Resources/TopDownInputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Resources/TopDownInputActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @TopDownInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Puzzle"",
            ""id"": ""b7ea8f3c-0ab5-4081-a5ba-a9124c8cce1d"",
            ""actions"": [
                {
                    ""name"": ""LeftClick"",
                    ""type"": ""Button"",
                    ""id"": ""e31b1315-cc68-457c-9906-bc84b65f1a71"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""RightClick"",
                    ""type"": ""Button"",
                    ""id"": ""5092895f-2334-4e00-a9ee-55dd029a18d8"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""de36447f-9111-4daa-9743-b84eae675bac"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c69afe94-be3b-47f9-aa39-43865d617370"",
    ...
    ""controlSchemes"": []
        ...
        m_Puzzle_LeftClick = m_Puzzle.FindAction("LeftClick", throwIfNotFound: true);
    ...
    ~@TopDownInputActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Puzzle.enabled, "This will cause a leak and performance issues, TopDownInputActions.Puzzle.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Puzzle_LeftClick;
    ...
    public struct PuzzleActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PuzzleActions(@TopDownInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Puzzle/LeftClick".
        /// </summary>
        public InputAction @LeftClick => m_Wrapper.m_Puzzle_LeftClick;
        /// <summary>
